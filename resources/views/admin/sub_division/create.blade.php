...
<div class="page-content">
    ...
    <div class="panel">
      <div class="panel-body">
        <form method="POST" action="{{ route('admin.sub_division.store') }}" id="userForm">
          {{ csrf_field() }}
          <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-4">
              ...
              <input required type="text" class="form-control" name="sub_division_code"
                placeholder=""/>
                @if ($errors->has('sub_division_code'))
                    <label class="error" for="sub_division_code">{{ $errors->first('sub_division_code') }}</label>
                @endif
            </div>
