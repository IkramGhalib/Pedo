...
<div class="page-content">
    ...
    <div class="panel">
      <div class="panel-body">
        <form method="POST" action="{{ route('admin.send.question') }}" enctype="multipart/form-data" id="userForm">
          {{ csrf_field() }}
          ...
          <div class="form-group col-md-6">
            ...
            <textarea class="form-control" placeholder="Write your Option 1" id="editor1" name="opt_1"></textarea>
            @if ($errors->has('opt_1'))
        ...
        @endif
          ...
          <div class="form-group col-md-6">
            ...
            <textarea class="form-control" placeholder="Write your Option 2" id="editor2" name="opt_2"></textarea>
            @if ($errors->has('opt_2'))
        ...
        @endif
          ...
          <div class="form-group col-md-6">
            ...
            <textarea  class="form-control" id="editor3" placeholder="Write your Option 3"  placeholder="Option 3" name="opt_3"></textarea>
            @if ($errors->has('opt_3'))
        ...
        @endif
          ...
          <div class="form-group col-md-6">
            ...
            <textarea class="form-control"  id="editor4"  placeholder="Write your Option 4"name="opt_4"></textarea>
            @if ($errors->has('opt_4'))
