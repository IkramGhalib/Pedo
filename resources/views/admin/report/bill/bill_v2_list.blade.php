...
<div class="maincontent fontsize">
        ...
        <table class="maintable" cellpadding="0" cellspacing="0">
            ...
            <tr style="height: 26px; width: 100%; font-size: .8em;" class="content">
                <td class="border-rb text-center" >
        ...
        <div style="height: auto; width: 400px; float: right;">
            <table style="width: 100%" cellpadding="0" cellspacing="0">
                <tbody><tr style="height: 27px;" class="fontsize">
                    ...
                    <td  class="content border-b text-center" >
                ...
                <tr style="height: 27px; width: 100%;" class="fontsize">
                    ...
                    <td colspan="3"  class="content border-b text-center">
        ...
        <table class="maintable" cellpadding="0" cellspacing="0">
            ...
            <!-- i change width here  -->
                ...
                <td style="float: right; width: 300pt; height: 20pt">
                    <table style="height: 10pt" class="nested6 text-center">
        ...
        <div class="border-t" style="width: 755pt; height: 430pt">
            <table class="nested7" style="width: 454pt; height: 100pt; float: left">
                ...
                <tr class="fontsize text-center" style="height: 24px;">
                ...
                <tr class="border-b fontsize text-center" style="height: 24px;">
        ...
        <div class="headertable fontsize " >
            ...
            <div class="" style=" margin-left:50px;display: inline-block; border: 1px solid #1a75ff; color: #1a75ff; padding: 20px; border-radius: 100%; width: 35px;">BANK
                <br>
                STAMP
            </div>
            ...
            <div style="width: 98%; margin: 0 auto 10px;">
                <table  style=" width: 100%; border-collapse: collapse;">
                    ...
                    <tr style="height: 40px;">
                        <td class="border-rb content text-center" style="width: 15%; text-align: center; border-left: 1px solid black;">
                            <!-- SEP 23 -->
                            {{$billing_month_year}}
                        </td>
