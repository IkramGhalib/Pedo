...
{
  $dataPoints[]=array("y" => $row, "label" => $m );
}
//  $dataPoints = array( 
// 	array("y" => 3373.64, "label" => "Pakistan" ),
...
<div style="width:1000px; margin-top:30px;text-center"> 
