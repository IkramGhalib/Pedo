...
<div class="page-content">
    ...
    <div class="panel">
      <div class="panel-body">
        <form method="POST" action="{{ route('admin.test.update',$test->id) }}" id="userForm">
          {{ csrf_field() }}
          ...
          <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <select class="form-control" name="course_id" required>
                    @foreach ($courses as $course)
                        <option value="{{ $course->id }}" {{ $course->id == $course->id ? 'selected' : '' }}>
                            {{ $course->course_title }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-4">
              ...
              <input required type="text" value="{{ $test->test_title }}" class="form-control" name="test_title"
          ...
          <div class="form-group col-md-4">
            ...
            <input type="date" value="{{ $test->test_start }}" class="form-control" name="test_start" required/>
          ...
          <div class="form-group col-md-4">
            ...
            <input type="date" class="form-control" value="{{ $test->test_end }}" name="test_end" required/>
          ...
          <div class="form-group col-md-4">
            ...
            <input required type="time"  id="timeInput1" value="{{ $test->time_start }}" class="form-control" name="time_start"/>
          ...
          <div class="form-group col-md-4">
            ...
            <input required type="time" value="{{ $test->time_end }}"  id="timeInput2" class="form-control" name="time_end"/>
          ...
          <div class="form-group col-md-4">
            ...
            <div>
              <div class="radio-custom radio-default radio-inline">
                <input  type="radio" id="inputBasicActive" name="status"  value="1" @if($test->status) checked @endif  />
                <label for="inputBasicActive">Active</label>
              </div>
              <div class="radio-custom radio-default radio-inline">
                <input  type="radio" id="inputBasicInactive" name="status" value="0" @if($test->status) checked @endif />
