...
<div class="panel">
  <div class="panel-body">
    ...
    <form method="POST" action="{{ route('admin.settingCourse.save') }}" enctype="multipart/form-data" id="courseForm">
      {{ csrf_field() }}
      ...
      <div class="row">
       ...
       <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-3">
            ...
            <select class="form-control" name="instructor_id">
                ...
                @foreach($instructor as $instructors)
                    ...
                    @if($instructors->id == $course->instructor_id){{ 'selected' }}@endif>
        ...
        <div class="form-group col-md-3">
            <label class="form-control-label">Thumb Image</label>
            <input type="file" class="form-control" name="thumb_image" id="thumb_image" value="{{ $course->thumb_image }}"
                />
        </div>

        <div class="form-group col-md-3">
            <label class="form-control-label">Video Image</label>
            <input type="file" name="course_video" id="course_video" accept="video/*">
            <input type="hidden" name="original_course_video" value="{{ $course->course_video }}">
    ...
    { 
        ...
        $("#courseForm").validate({
            ...
            messages: {
                ...
                instructor: {
                    required: 'The instructor field is required.'
                }
            }
        });
