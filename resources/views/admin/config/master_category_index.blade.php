          ...
          <table class="table table-hover table-striped w-full">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="{{ url('admin/config/setting-category/'.$category->id) }}" class="btn btn-xs btn-icon btn-inverse btn-round" data-toggle="tooltip" data-original-title="Edit" >
                    <i class="icon wb-pencil" aria-hidden="true"></i>
                  </a>

                  <a href="{{ url('admin/config/delete-category/'.$category->id) }}" class="delete-record btn btn-xs btn-icon btn-inverse btn-round" data-toggle="tooltip" data-original-title="Delete" >
