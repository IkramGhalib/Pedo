        ...
        <div class="form-group col-md-6">
            ...
            <label class="cabinet center-block">
                <figure class="course-image-container">
                    ...
                    <img src="@if($course->course_image){{asset('course').'/'.$course->course_image}}@else{{ asset('backend/assets/images/course_detail.jpg') }}
                                @endif" class=" img-responsive" id="" name="course_image-output" />
                </figure>
            </label>
        </div>
                    ...
                    {{-- <div class="input-group input-group-file" data-plugin="inputGroupFile"> --}}
                        ...
                        {{-- <span class="input-group-btn"> --}}
                          {{-- <span class="btn btn-success btn-file"> --}}
                            ...
                            <input type="file" class="center-block" name="course_image"  />
...
<script type="text/javascript">
    ...
    { 
        //image crop start
        // $(".gambar").attr("src", @if($course->course_image))"{{ Storage::disk('public_course')->path($course->course_image) }}" @else "{{ asset('backend/assets/images/course_detail.jpg') }}" @endif);
