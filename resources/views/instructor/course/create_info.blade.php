    ...
    <form method="POST" action="{{ route('instructor.course.info.save') }}" id="courseForm">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <input readonly type="text" class="form-control" name="course_title" 
        ...
        <div class="form-group col-md-4">
            ...
            <input type="number" class="form-control" name="strike_out_price" 
        ...
        <div class="form-group col-md-4">
            ...
            <select class="form-control" name="instructor">
                ...
                @foreach($instructor as $ins)
                    <option value="{{ $ins->id }}"
                    @if($ins->id == $course->instructor_id){{ 'selected' }}@endif>
                        {{ $ins->first_name }}
                    </option>
                @endforeach
            </select>
            ...
            @if ($errors->has('instructor'))
                <label class="error" for="category_id">{{ $errors->first('instructor') }}</label>
            @endif
        </div>
