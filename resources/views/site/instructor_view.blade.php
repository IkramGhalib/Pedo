            ...
            <div class="row mt-4">
                <div class="col-xl-3 col-lg-4 col-md-5 d-none d-md-block">
                    <div class="instructor-profile-box mx-auto">
                        <main>
                            <img src="@if($instructor->instructor_image && $instructor->instructor_image){{ $instructor->instructor_image }}@else{{ asset('backend/assets/images/course_detail_thumb.jpg') }}@endif">
                            <div class="col-12">
