...
.generic_feature_list a{
    color: black;
    font-waight:bold;
}
.generic_feature_list a:hover{
    color: #ee3137;
    font-waight:bold;
}
...
#generic_price_table .generic_content .generic_head_price .generic_head_content .head_bg{
    border-style: solid;
    border-width: 110px 1411px 23px 399px;
	position: absolute;
}
                    ...
                    <div class="generic_content clearfix ">
                        ...
                        <div class="generic_head_price clearfix">
                            ...
                            <div class="generic_head_content clearfix">
                                ...
                                <div class="head">
                                    <span>{{$row->cat_name}}</span><i style="font-size:12px;"> <br/>  {{get_group_no($row->id)}}/{{$row->name}} </i>
                                </div>
                                <!--//HEAD END-->
                        ...
                        <div class="generic_feature_list">
                            ...
                            @foreach($row->courses as $course)
                            	<li>
                                    <div class="row">
                                        <div class="col-md-8">
                                    <span><a href="{{route('course.view',$course->course_slug)}}">{{$i}}. {{ $course->course_title }} </a> @if($row->registration_method !='whole')<span style="float:right; padding-right:5px;">RS. {{$course->price}}</span>@endif</span> <br/><a href="{{route('instructor.view',$course->instructor_slug)}}">By : {{ $course->first_name.' '.$course->last_name }}</a> </div>
                                    <div
                                     class="col-md-4"> @if($row->registration_method !='whole') <button class="btn btn-success btn-outline btn-sm addToCartBtn" data-groupid="{{ $row->id }}" data-course="{{$course->id}}">
                        ...
                        <div class="generic_price_btn clearfix">
                        	<a href="#" class="addToCartBtn" data-groupid="{{ $row->id }}" data-course=""  >Add To Cart</a>
                        </div>
                        @endif
                        <!--//BUTTON END-->
