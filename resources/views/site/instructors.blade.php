                    ...
                    <div class="row mt-4 mb-5">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            ...
                            <a href="{{ route('instructor.view', $instructor->instructor_slug) }}">
                                <main>
                                    <img src="@if($instructor->instructor_image && Storage::exists($instructor->instructor_image)){{ Storage::url($instructor->instructor_image) }}@else{{ asset('backend/assets/images/course_detail_thumb.jpg') }}@endif">
                                    <div class="col-md-12">
