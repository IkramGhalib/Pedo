                    ...
                    <div class="generic_content clearfix ">
                        ...
                        <div class="generic_head_price clearfix">
                            ...
                            <div class="generic_head_content clearfix">
                                ...
                                <div class="head">
                                    <span>QCA</span><i style="font-size:12px;">   </i>
                                </div>
                                <!--//HEAD END-->
                            ...
                            <div class="generic_price_tag clearfix">	
                                <span class="price">
                                    ...
                                    <span class="currency">
                                        <?php if($charges)
                                            echo $charges->option_value;
                                        else 
                                            echo '500';
                                        ?>
                                        </span>
                                    <span class="month">/Test</span>
                        	...
                        	<ul>
                            	...
                            	<li>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                    <input type="number" value="1" name="test" class="form-control test">  
                                        </div>
                                    </div>
                            </li>
                        ...
                        <div class="generic_price_btn clearfix">
                        	<a href="#" class="addToCartBtn" data-groupid="" data-course=""  >Add To Cart</a>
                        </div>
