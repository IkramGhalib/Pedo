...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2023 at 11:20 AM
...
(32, '2023-10-01', 'generated', 1, '2023-10-13 04:42:16', '2023-10-13 04:42:16', '2023-10-13', 0);
...
INSERT INTO `consumer_bills` (`id`, `generate_bill_id`, `reading_id`, `ref_no`, `billing_month_year`, `peak_units`, `offpeak_units`, `PrevU`, `PresU`, `Units`, `FreeU`, `currentbill`, `net_bill`, `Arrears`, `GTotal`, `off_peak_bill_breakup`, `charges_breakup`, `taxes_breakup`, `WithinDuedate`, `AfterdueDate`, `Rec`, `IssueDate`, `DueDate`, `IsPayed`, `paid_amount`, `paid_on`, `paid_by`, `uploaded_datetime`, `Observation`, `l_p_surcharge`) VALUES
(7, 32, 2, '8261420391904', '2023-10-01', 0, 200, 0, 0, 0, 0, 2012, 0, 0, 0, '[{\"units\":200,\"charges\":10.06}]', '[]', '[{\"tax_type\":\"F.P.A\",\"percentage\":0.43,\"calculated_tax\":0.86},{\"tax_type\":\"F.P.A\",\"percentage\":0,\"calculated_tax\":0}]', 2012, 50, 0, '2023-10-13 04:42:16', '2023-10-13 00:00:00', '0', 0, NULL, NULL, NULL, NULL, 0);
