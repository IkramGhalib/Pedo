...
CREATE TABLE `banks` (
  ...
  `bank_desc` text COLLATE utf8mb4_general_ci
...
CREATE TABLE `bill_generates` (
  ...
  `status` varchar(50) COLLATE utf8mb4_general_ci DEFAULT 'generated',
...
(1, '2023-09-01', 'generated', 1, '2023-10-30 06:40:52', '2023-10-30 06:40:52', '2023-11-10', 0),
(2, '2023-10-01', 'generated', 1, '2023-10-30 07:17:04', '2023-10-30 07:17:04', '2023-11-10', 0);
...
CREATE TABLE `consumers` (
  ...
  `consumer_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'IKRAM ULLAH', 'KHAN GHALIB', '1710142738347', 'new colony , sardheri charsadda', '1', NULL, NULL, '03335959967', '0.00', 1, 'Disable', '2023-09-27 05:43:11', '2023-10-17 05:39:42', 1),
(2, 'Khan', 'Khan Ghalib', '12587945666', 'Peshawar', '2', NULL, NULL, '034812334568', '0.00', 1, 'active', '2023-10-17 06:32:43', '2023-10-17 06:32:43', 1),
(3, 'Sultan Murad', 'Khan', '111', 'Village Reshun Chitral', '3', NULL, NULL, '0', '0.00', 1, 'active', '2023-10-19 05:09:39', '2023-10-19 05:09:39', 3),
...
(6, 'afridi', 'afridi', '123123123', 'kohat road', '6', NULL, NULL, '0123123', '0.00', 1, 'active', '2023-10-30 01:14:49', '2023-10-30 01:14:49', 1),
(7, 'afridi', 'afridi', '12312333322211', 'abc', '7', NULL, NULL, '0321456789', '0.00', 1, 'active', '2023-10-30 01:16:09', '2023-10-30 01:16:09', 1),
(8, 'afridi', 'afridi', '123123333222104', 'abc', '8', NULL, NULL, '0321456789', '0.00', 1, 'active', '2023-10-30 01:17:12', '2023-10-30 01:17:12', 1),
(9, 'afridi', 'afridi', '12312333399', 'abc', '9', NULL, NULL, '0214563541', '0.00', 1, 'active', '2023-10-30 01:18:24', '2023-10-30 01:18:24', 1);
...
(1, 1, 1, 1, '8261420391904', '2023-09-01', 0, 200, 0, 0, 0, 0, 1780, 30, 334, 2144, 0, 2144, '[{\"units\":100,\"charges\":7.74},{\"units\":100,\"charges\":10.06}]', '[{\"code\":\"QTRTA\",\"charges\":1.24,\"calculated_charges\":248,\"charges_type\":\"Q.T Adjustment\"},{\"code\":null,\"charges\":0.43,\"calculated_charges\":86,\"charges_type\":\"F.S Surcharge\"}]', '[{\"code\":\"ED\",\"tax_type\":\"E.D\",\"percentage\":1.5,\"calculated_tax\":30.419999999999998},{\"code\":\"EDFPA\",\"tax_type\":\"E.D on FPA\",\"percentage\":1.5,\"calculated_tax\":0}]', 2144, 2322, 0, '2023-10-30 06:40:52', '2023-11-10 00:00:00', '0', 0, NULL, NULL, NULL, NULL, 178, 2, ''),
(2, 1, 2, 5, '1682261', '2023-09-01', 0, 150, 0, 0, 0, 0, 5693, 88, 186, 5967, 0, 5967, '[{\"units\":150,\"charges\":37.95}]', '[{\"code\":\"QTRTA\",\"charges\":1.24,\"calculated_charges\":186,\"charges_type\":\"Q.T Adjustment\"}]', '[{\"code\":\"ED\",\"tax_type\":\"E.D\",\"percentage\":1.5,\"calculated_tax\":88.1775},{\"code\":\"EDFPA\",\"tax_type\":\"E.D on FPA\",\"percentage\":1.5,\"calculated_tax\":0}]', 5967, 6536, 0, '2023-10-30 06:40:52', '2023-11-10 00:00:00', '0', 0, NULL, NULL, NULL, NULL, 569, 4, ''),
(3, 2, 6, 5, '1682261', '2023-10-01', 0, 100, 0, 0, 0, 0, 3795, 118, 124, 4037, 5967, 10004, '[{\"units\":100,\"charges\":37.95}]', '[{\"code\":\"QTRTA\",\"charges\":1.24,\"calculated_charges\":124,\"charges_type\":\"Q.T Adjustment\"}]', '[{\"code\":\"ED\",\"tax_type\":\"E.D\",\"percentage\":3,\"calculated_tax\":117.57000000000001},{\"code\":\"EDFPA\",\"tax_type\":\"E.D on FPA\",\"percentage\":3,\"calculated_tax\":0}]', 10004, 10383, 0, '2023-10-30 07:17:04', '2023-11-10 00:00:00', '0', 0, NULL, NULL, NULL, NULL, 380, 4, 'A2');
...
CREATE TABLE `consumer_categories` (
  ...
  `tarrif_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `consumer_ledgers` (`id`, `consumer_id`, `amount`, `remarks`, `created_at`, `bill_id`, `payment_id`) VALUES
(1, 1, 2144, '', NULL, 1, NULL),
(2, 5, 5967, '', NULL, 2, NULL),
(3, 5, 4037, '', NULL, 3, NULL);
...
(6, 9, 4, '42261811', 11, '2023-10-30', '2023-10-30', 0, 0);
...
INSERT INTO `consumer_sub_categories` (`id`, `consumer_category_id`, `name`, `category_conditon_start`, `category_conditon_end`, `is_active`, `created_at`, `updated_at`, `check_months`, `last_slab_apply`) VALUES
(1, 1, 'Life line', 1, 100, 1, NULL, NULL, 12, 0),
(2, 1, 'Protected', 101, 200, 1, NULL, NULL, 6, 0),
(3, 1, 'un-protected', 0, 0, 0, NULL, NULL, 0, 1),
(4, 2, 'Commerial', 1, 70000, 1, NULL, NULL, 0, 1),
(7, 3, 'industrial', 1, 100000, 1, NULL, NULL, 1, 0),
(8, 1, 'Un-protected', 1, 50000, 1, NULL, NULL, 0, 1);
...
CREATE TABLE `general_taxs` (
  ...
  `applicable_on` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'units',
...
CREATE TABLE `invoices` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `create_from_place` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `uploaded_receipt` text COLLATE utf8mb4_unicode_ci,
  ...
  `paid_from` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `invoice_details` (
  ...
  `discount` int NOT NULL DEFAULT '0',
  `fee_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'course' COMMENT 'course/exam',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `meters` (
  `meter_id` int NOT NULL,
  `meter_no` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'free'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, NULL, 1, '8261420391904', '2023-09-01', '23', '09', 0, 200, 200, NULL, 0, NULL, NULL, '2023-10-30 06:39:20', NULL, NULL, NULL, b'0', NULL, NULL, 0, NULL, 1),
(2, NULL, 5, '1682261', '2023-09-01', '23', '09', 0, 150, 150, NULL, 0, NULL, NULL, '2023-10-30 06:39:40', NULL, NULL, NULL, b'0', NULL, NULL, 0, NULL, 1),
(6, NULL, 5, '1682261', '2023-10-01', '23', '10', 150, 250, 100, NULL, 0, NULL, NULL, '2023-10-30 06:55:59', NULL, NULL, NULL, b'0', NULL, NULL, 0, NULL, 1),
(7, NULL, 1, '8261420391904', '2023-11-01', '23', '11', 0, 350, 350, NULL, 0, NULL, '1698657815op.jpg', '2023-10-30 09:23:35', NULL, NULL, NULL, b'0', NULL, NULL, 0, NULL, 0),
(11, NULL, 1, '8261420391904', '2023-12-01', '23', '12', 350, 400, 50, NULL, 0, NULL, NULL, '2023-10-30 09:32:06', NULL, NULL, NULL, b'0', NULL, NULL, 0, NULL, 0),
(12, NULL, 1, '8261420391904', '2024-01-01', '24', '01', 400, 500, 100, NULL, 0, NULL, NULL, '2023-10-30 10:18:33', NULL, NULL, NULL, b'0', NULL, NULL, 0, NULL, 0),
(13, NULL, 1, '8261420391904', '2024-02-01', '24', '02', 500, 600, 100, NULL, 0, NULL, NULL, '2023-10-30 10:19:42', NULL, NULL, NULL, b'0', NULL, NULL, 0, NULL, 0),
(14, NULL, 1, '8261420391904', '2024-03-01', '24', '03', 600, 500, 100, NULL, 0, NULL, NULL, '2023-10-30 10:29:46', NULL, NULL, NULL, b'0', NULL, NULL, 0, NULL, 0),
(15, NULL, 1, '8261420391904', '2024-05-01', '24', '05', 0, 400, 400, NULL, 0, NULL, NULL, '2023-10-30 10:33:08', NULL, NULL, NULL, b'0', NULL, NULL, 0, NULL, 0);
...
(38, 'settingCharges', 'late_fee_surcharge', '10');
...
INSERT INTO `payment_receives` (`id`, `payment_month`, `payment_date`, `payment_amount`, `ref_no`, `bank_id`, `conumer_id`, `bill_id`) VALUES
(12, '2023-09-01', '2023-10-27', 2100, 16822600001000, 1, 3, 3);
...
(1, '2023-09-01', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 1),
(3, '2023-10-01', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 1);
...
(3, 8, 2, 1.8, 1, 'units', 'FPA'),
(4, 4, 2, 1.81, 1, 'units', 'FPA'),
(5, 1, 3, 1.24, 1, 'units', 'QTRTA'),
(6, 2, 3, 1.24, 1, 'units', 'QTRTA'),
(7, 4, 3, 1.24, 1, 'units', 'QTRTA'),
(8, 8, 3, 1.24, 1, 'units', 'QTRTA'),
(9, 1, 1, 0, 1, 'units', NULL),
(10, 2, 1, 0.43, 1, 'units', NULL),
(11, 8, 1, 3.32, 1, 'units', NULL);
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `reg_no` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `retrive_uniq_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
