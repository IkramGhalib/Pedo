...
(5, '2023-09-01', 'generated', 1, '2023-10-24 07:00:36', '2023-10-24 07:00:36', '2023-10-24', 0);
...
INSERT INTO `consumer_bills` (`id`, `generate_bill_id`, `reading_id`, `ref_no`, `billing_month_year`, `peak_units`, `offpeak_units`, `PrevU`, `PresU`, `Units`, `FreeU`, `currentbill`, `total_taxes`, `total_charges`, `net_bill`, `Arrears`, `gTotal`, `off_peak_bill_breakup`, `charges_breakup`, `taxes_breakup`, `WithinDuedate`, `AfterdueDate`, `Rec`, `IssueDate`, `DueDate`, `IsPayed`, `paid_amount`, `paid_on`, `paid_by`, `uploaded_datetime`, `Observation`, `l_p_surcharge`, `sub_cat_finded_id`) VALUES
(1, 5, 2, '16822600001000', '2023-09-01', 0, 200, 0, 0, 0, 0, 1780, 53, 696, 2529, 0, 2529, '[{\"units\":100,\"charges\":7.74},{\"units\":100,\"charges\":10.06}]', '[{\"charges\":0.43,\"calculated_charges\":86,\"charges_type\":\"Fc Surcharge for Protected\"},{\"charges\":1.81,\"calculated_charges\":362,\"charges_type\":\"Fuel Price Adjustment\"},{\"charges\":1.24,\"calculated_charges\":248,\"charges_type\":\"QTR Tarrif ADJ\"}]', '[{\"tax_type\":\"E.D\",\"percentage\":1.5,\"calculated_tax\":26.7},{\"tax_type\":\"E.D on FPA\",\"percentage\":1.5,\"calculated_tax\":26.7}]', 2529, 2707, 0, '2023-10-24 07:00:36', '2023-10-24 00:00:00', '0', 0, NULL, NULL, NULL, NULL, 178, 2);
...
(2, NULL, '16822600001000', '2023-09-01', '2023', '09', 200, 200, NULL, 0, NULL, NULL, '2023-10-24 07:00:12', NULL, NULL, NULL, b'0', '1', NULL, 0, NULL, 1);
...
(7, 4, 17, 1.81, 1, 'units', NULL),
(8, 1, 17, 1.81, 1, 'units', NULL),
(9, 2, 17, 1.81, 1, 'units', NULL),
(10, 8, 17, 1.81, 1, 'units', NULL),
(11, 1, 18, 0, 1, 'units', NULL),
(12, 2, 18, 1.24, 1, 'units', NULL),
(13, 4, 18, 1.24, 1, 'units', NULL),
